...
#         'good_for_rainy_day': rain,
#         'adventurous': adventurous,
#         'suitable_for_children': children,
#         'suitable_for_large_group': group,
#         'suitable_for_couple': couple,
#         'extreme_sports': extreme,
#         'affordable': affordable,
#         'games_and_recreation': games,
#         'nightlife': night,
#         'casino_and_gambling': casino,
#         'zoo_and_aquarium': zoo,
#         'concert_and_show': concert,
#         'course_and_studio': course,
#         'honeymoon_destination': honeymoon,
#         'food_and_beverage': fnb,
#         'free_entry': free,
#         'museum': museum,
#         'scenic_spot': scenery,
#         'spa_and_wellness': spa,
#         'tourist_information': info,
#         'water_and_amusement_park': water,
#         'shopping': shop,
#         'unpopular_destination': unpopular,
#         'nature_and_wildlife': nature
#     }
...
def hasil():
    ...
    if request.method == 'POST':
        ...
        list_activity=cv.get_feature_names_out()

        cv.get_feature_names_out()

        cv_df = pd.DataFrame(cv_result.todense(),columns= cv.get_feature_names_out(),index=df1['Travel Destination'])
        cv_df
        ...
        cv_spot.get_feature_names_out()

        cv_df_spot = pd.DataFrame(cv_spot_result.todense(),columns= cv_spot.get_feature_names_out(),index=df2['Spot/Vendor'])
        cv_df_spot
